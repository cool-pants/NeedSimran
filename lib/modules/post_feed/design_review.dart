...
class designReviewUI extends StatefulWidget {
  @override
  _designReviewUIState createState() => _designReviewUIState();
}

class _designReviewUIState extends State<designReviewUI> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(    
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          backgroundColor: Color.fromRGBO(91, 192, 222,1.0),
          centerTitle:true,
          leading: Column(
      ...
      body: Stack(
        children: <Widget>[
          ...
          //             child:new Theme(
          //               data:new ThemeData(
          //               primaryColor: Color.fromRGBO(91, 192, 222,1.0),
