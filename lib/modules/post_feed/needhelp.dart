...
class needHelpUI extends StatefulWidget {
  @override
  _needHelpUIState createState() => _needHelpUIState();
}

class _needHelpUIState extends State<needHelpUI> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(    
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          backgroundColor: Color.fromRGBO(255, 140, 55,1.0),
          centerTitle:true,
          leading: Column(
                  ...
                  child: new Column(
                    children:<Widget>[
                     new Form(
                      ...
                      child:new Theme(
                        data:new ThemeData(
                        primaryColor: Color.fromRGBO(255, 140, 55,1.0),
