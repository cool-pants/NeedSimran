...
class codeReviewUI extends StatefulWidget {
  @override
  _codeReviewUIState createState() => _codeReviewUIState();
}

class _codeReviewUIState extends State<codeReviewUI> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(    
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          backgroundColor: Color.fromRGBO(51, 214, 166,1.0),
          centerTitle:true,
          leading: Column(
      ...
      body: Stack(
        children: <Widget>[
          ...
          //             child:new Theme(
          //               data:new ThemeData(
          //               primaryColor: Color.fromRGBO(51, 214, 166,1.0),
