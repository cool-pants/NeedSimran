...
class linkedINUI extends StatefulWidget {
  @override
  _linkedINUIState createState() => _linkedINUIState();
}

class _linkedINUIState extends State<linkedINUI> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(    
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          backgroundColor: Color.fromRGBO(63, 15, 63,1.0),
          centerTitle:true,
          leading: Column(
      ...
      body: Stack(
        children: <Widget>[
          ...
          //             child:new Theme(
          //               data:new ThemeData(
          //               primaryColor: Color.fromRGBO(63, 15, 63,1.0),
